...
3. **Residual stays f32 in v1**; the relu2 stage is solved integer-exactly
   (Phase 4, see the table row above). Full-integer residual is the one
   remaining open fixed-point item.
